...
- 하단 세 버튼(헷갈려요·저장·외웠어요)을 모두 글씨 너비에 맞춰 줄이고 좌우 여백 8px, 글씨 14px 로 통일한 뒤 가운데 정렬. 양옆만 flex-1 로 늘어나 있어 크기도 여백도 제각각으로 보이던 것을 정리
- 저장 버튼은 고정폭을 걷어내고 글씨에 맞췄다. 담기면 '저장'→'저장됨' 으로 한 자 늘어나 버튼이 그만큼 넓어진다
