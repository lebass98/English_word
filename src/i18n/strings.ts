...
const ko = {
  ...
  "quiz.chooseKind": "어떤 문제로 풀까요?",
  "quiz.kind.mix": "섞어서",
  "quiz.kind.mixDesc": "일곱 가지가 골고루",
  "quiz.kind.imageToWord": "그림 보고 단어",
  "quiz.kind.imageToWordDesc": "그림을 보고 단어 고르기",
  "quiz.kind.wordToImage": "단어 보고 그림",
  "quiz.kind.wordToImageDesc": "단어를 보고 그림 고르기",
  "quiz.kind.wordToMeaning": "단어 보고 뜻",
  "quiz.kind.wordToMeaningDesc": "단어를 보고 뜻 고르기",
  "quiz.kind.meaningToWord": "뜻 보고 단어",
  "quiz.kind.meaningToWordDesc": "뜻을 보고 단어 고르기",
  "quiz.kind.listenToWord": "듣고 단어",
  "quiz.kind.listenToWordDesc": "발음을 듣고 단어 고르기",
  "quiz.kind.cloze": "예문 빈칸",
  "quiz.kind.clozeDesc": "문장 빈칸에 넣을 단어",
  "quiz.kind.spelling": "철자 맞추기",
  "quiz.kind.spellingDesc": "글자를 하나씩 채우기",
  "quiz.hint": "힌트",
...
const ja: Partial<Record<StringKey, string>> = {
  ...
  "quiz.chooseKind": "どの問題で解く?",
  "quiz.kind.mix": "ミックス",
  "quiz.kind.mixDesc": "7種類をまんべんなく",
  "quiz.kind.imageToWord": "絵から単語",
  "quiz.kind.imageToWordDesc": "絵を見て単語を選ぶ",
  "quiz.kind.wordToImage": "単語から絵",
  "quiz.kind.wordToImageDesc": "単語を見て絵を選ぶ",
  "quiz.kind.wordToMeaning": "単語から意味",
  "quiz.kind.wordToMeaningDesc": "単語を見て意味を選ぶ",
  "quiz.kind.meaningToWord": "意味から単語",
  "quiz.kind.meaningToWordDesc": "意味を見て単語を選ぶ",
  "quiz.kind.listenToWord": "聞いて単語",
  "quiz.kind.listenToWordDesc": "発音を聞いて単語を選ぶ",
  "quiz.kind.cloze": "空欄うめ",
  "quiz.kind.clozeDesc": "文の空欄に入る単語",
  "quiz.kind.spelling": "つづり当て",
  "quiz.kind.spellingDesc": "文字を一つずつ埋める",
  "quiz.hint": "ヒント",
