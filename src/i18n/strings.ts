...
const ko = {
  ...
  "settings.autoAdvanceSec": "넘김 간격",
  "settings.autoAdvanceSecValue": "{sec}초",
  "settings.speechVolume": "발음 소리 크기",
  "settings.speechVolumeDesc": "학습 화면에서 스피커를 누를 때 나는 소리예요",
  "settings.speechMuted": "음소거",
  "settings.speechVolumeLevel": "소리 크기 {percent}퍼센트",
  ...
  "quiz.pickWordByMeaning": "이 뜻을 가진 단어는?",
  "quiz.listen": "잘 듣고 단어를 고르세요",
  "quiz.cloze": "빈칸에 들어갈 단어는?",
  "quiz.spell": "철자를 맞혀 보세요",
  "quiz.replay": "다시 듣기",
  "quiz.spellHint": "글자를 눌러 채우세요",
  "quiz.unitTitle": "UNIT {unit} 확인 퀴즈",
...
const ja: Partial<Record<StringKey, string>> = {
  ...
  "settings.autoAdvanceSec": "送る間隔",
  "settings.autoAdvanceSecValue": "{sec}秒",
  "settings.speechVolume": "発音の音量",
  "settings.speechVolumeDesc": "学習画面でスピーカーを押したときの音の大きさです",
  "settings.speechMuted": "ミュート",
  "settings.speechVolumeLevel": "音量{percent}パーセント",
  ...
  "quiz.pickMeaning": "この単語の意味は?",
  "quiz.pickWordByMeaning": "この意味の単語は?",
  "quiz.listen": "よく聞いて単語を選ぼう",
  "quiz.cloze": "空欄に入る単語は?",
  "quiz.spell": "つづりを当ててみよう",
  "quiz.replay": "もう一度聞く",
  "quiz.spellHint": "文字を押して埋めよう",
  "quiz.unitTitle": "UNIT {unit} 確認クイズ",
